...
def test_application_dashboard_wiring():
    ...
    try:
        ...
        if app.dashboard is not None:
            ...
            assert hasattr(dash, "powerbi_display")
            ...
            # Exercise Dual-Mode toggle (Simple vs Engineer)
            assert dash._is_engineer_mode is False
            dash.toggle_engineer_mode()
            assert dash._is_engineer_mode is True
            dash.toggle_engineer_mode()
            assert dash._is_engineer_mode is False
